...
<div class="section">
    ...
    <div class="section-item">
        ...
        <em>In IEEE 19th International Conference on Cloud Computing (CLOUD), 2026 (To appear).</em></p>
        <div class="button-group">
            <a href="#" class="btn btn--primary btn-disabled" aria-disabled="true">Coming soon!</a>
            <button type="button" class="btn btn--primary bibtex-copy" data-bibtex-target="bibtex-flare-home">Bibtex</button>
...
<div class="section">
    ...
    <div class="section-item">
        <strong>ICTA Gold Medal - Best Final Year Computer Science Research Project (2021)</strong>
        <ul>
            <li>Awarded for the best undergraduate final year research project and thesis at UCSC.</li>
            <li>Thesis : Hardware software partitioning for FPGA based MPSoC.</li>
        </ul>
    </div>
    <div class="section-item">
        <strong>Presidential Award & Felicitation (2016)</strong>
        <ul>
            <li>Awarded for obtaining National Rank 2 at G.C.E. (A/L) Examination - 2015.</li>
        </ul>
    </div>
</div>
...
<div class="skills-grid">
    <div class="skill-card">
        <div class="skill-title">Cloud & Systems</div>
        <div class="skill-chips">
            <span class="skill-chip">AWS</span>
            <span class="skill-chip">Lambda</span>
            <span class="skill-chip">EC2</span>
            <span class="skill-chip">EKS</span>
    ...
    <div class="skill-card">
        <div class="skill-title">Programming & Backend</div>
        <div class="skill-chips">
            ...
            <span class="skill-chip">REST</span>
            <span class="skill-chip">gRPC</span>
        </div>
    </div>
    <div class="skill-card">
        <div class="skill-title">Frontend & Mobile</div>
        <div class="skill-chips">
    ...
    <div class="skill-card">
        <div class="skill-title">Data, Observability & Tooling</div>
        <div class="skill-chips">
...
<pre id="bibtex-flare-home" hidden>@inproceedings{dehigama2026flare,
...
<pre id="bibtex-hotinfra-home" hidden>@inproceedings{d494de1d227b46ed8429240dd9f9625b,
...
<pre id="bibtex-sesame-home" hidden>@conference{9987358b722b4062a1ace674d6699335,
